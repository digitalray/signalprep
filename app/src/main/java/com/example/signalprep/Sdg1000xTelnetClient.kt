...
/**
 * SDG1000X Telnet/Socket SCPI client.
 *
...
class Sdg1000xTelnetClient(
    ...
    private fun validateChannel(channel: Int) {
        require(channel == 1 || channel == 2) { "Channel must be 1 or 2 for SDG1000X." }
    }
}
